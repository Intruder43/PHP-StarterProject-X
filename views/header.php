...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <!--stylsheet-->
        <link rel="stylesheet" href="libs/Vendors/bootstrap-3.3.6-dist/css/bootstrap.css">
        <link rel="stylesheet" href="libs/Vendors/triand/css.css">
        <style>
            /*Grid*/
            .ui-jqgrid {
                position: relative;
        ...
        <!--Script JS-->
        <script src="libs/Vendors/jquery-3.3.1/jquery-2.2.4.js"></script>
        <script src="libs/Vendors/bootstrap-3.3.6-dist/js/bootstrap.js"></script>
        <script src="libs/Vendors/triand/jquery.jqGrid.min.js"></script>
    </head>
</html>